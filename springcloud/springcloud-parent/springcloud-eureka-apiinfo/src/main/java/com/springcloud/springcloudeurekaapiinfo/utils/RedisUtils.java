...
public class RedisUtils {
    ...
    public String get(String key){
        return get(key,SystemConstant.SYSTEM_NUN_0);
    }

    /**
     * 根据key获取对应的value
     *
     * @param key 这个是redis中对应的key
     * @param indexDb 这个是redis对应的db的序号  redis有16个数据库 这里默认是选择的0
     * @return
     */
    public String get(String key , int indexDb){
        //考虑到线程安全的原因，这里的jedis的属性最好不要设置成全局的
        Jedis jedis = null;
        String value = "";
